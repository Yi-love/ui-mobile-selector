...
/***/ function(module, exports) {
	...
	var Render = function () {
	    ...
	    Render.prototype.escape = function escape(html) {
	        return String(html).replace(/&(?!\w+;)/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#039;');
	    };

	    Render.prototype.complie = function complie(str) {
	    ...
	    Render.prototype.render = function render(str, data) {
	...
	var SelectorManager = function () {
	    ...
	    SelectorManager.prototype.appendCssWrapper = function appendCssWrapper() {
	        try {
	    ...
	    SelectorManager.prototype.addCommonCss = function addCommonCss(css) {
	        if (!css) return this;
	        try {
	    ...
	    SelectorManager.prototype.removeCommonCss = function removeCommonCss() {
	        try {
	    ...
	    SelectorManager.prototype.addSelector = function addSelector(selector) {
	        var name = selector.name && !this.selectors[selector.name] ? selector.name : this.getName();
	        this.setCount(1);
	        this.selectors[name] = selector;
	        return name;
	    };

	    SelectorManager.prototype.removeSelector = function removeSelector(selectorName) {
	    ...
	    SelectorManager.prototype.efficientGlobal = function efficientGlobal(selectorName) {
	    ...
	    SelectorManager.prototype.setCount = function setCount(dir) {
	        this.count += dir;
	        this.count = this.count < 0 ? 0 : this.count;
	        return this;
	    };

	    SelectorManager.prototype.getName = function getName() {
	...
	var Selector = function () {
	    function Selector(props) {
	        ...
	        '<%for ( var i = 0 ,len = list.length ; i < len ; i++ ){%>', '<li class=' + '"<%=listerClassName+(selected === i ? " "+selectClassName :"")%>"' + ' data-value="<%=list[i][alias.value]%>" data-index="<%=i%>">', '<span class="desc"><%=list[i][alias.text]%></span>', '</li>', '<%}%>', '</ul>'].join('');
	    ...
	    Selector.prototype.init = function init() {
	        return this.addCss().addClass(this.wrapper, this.selectorMenuClassName).addClass(this.container, this.selectorListerClassName).setEffectiveValue().render().addEventListener().addToSelectorManager();
	    };

	    Selector.prototype.extendProps = function extendProps(props) {
	        if ({}.toString.call(props) !== '[object Object]') {
	            return this;
	        }
	    ...
	    Selector.prototype.addCss = function addCss() {
	        if (this.cssTxt) {
	    ...
	    Selector.prototype.setList = function setList(list) {
	    ...
	    Selector.prototype.setEffectiveValue = function setEffectiveValue() {
	    ...
	    Selector.prototype.val = function val(value) {
	        if (value !== void 0) {
	            if (this.bind) {
	    ...
	    Selector.prototype.refVal = function refVal() {
	        if (this.bind) {
	    ...
	    Selector.prototype.addToSelectorManager = function addToSelectorManager() {
	        this.name = this.selectorManager.addSelector(this);
	        return this;
	    };

	    Selector.prototype.removeFromSelectorManager = function removeFromSelectorManager() {
	        this.selectorManager.removeSelector(this.name);
	        return this;
	    };

	    Selector.prototype.efficientGlobal = function efficientGlobal() {
	        if (this.global) {
	    ...
	    Selector.prototype.addEventListener = function addEventListener() {
	        var _this = this;
	        ...
	        var selectHandler = function selectHandler(e) {
	            ...
	            do {
	                if (_this.hasClass(target, _this.listerClassName)) {
	                    return _this.reSetListerClass(target).addClass(target, _this.selectClassName).selectIndex(+target.getAttribute('data-index'));
	                }
	                target = target.parentNode;
	            } while (target !== _this.container);
	        };
	        this.wrapper.addEventListener('click', function (e) {
	            e.stopPropagation();_this.toggle();
	        }, false);
	        this.container.addEventListener('click', selectHandler, false);
	        return this;
	    };

	    Selector.prototype.selectIndex = function selectIndex(idx) {
	    ...
	    Selector.prototype.runCallBack = function runCallBack() {
	    ...
	    Selector.prototype.runShowFun = function runShowFun() {
	    ...
	    Selector.prototype.runHideFun = function runHideFun() {
	    ...
	    Selector.prototype.reSetListerClass = function reSetListerClass(target) {
	        var list = target.parentNode.childNodes;
	        for (var i = 0, len = list.length; i < len; i++) {
	            if (list[i].nodeType === 1 && list[i] != target && this.hasClass(list[i], this.listerClassName) && this.hasClass(list[i], this.selectClassName)) {
	    ...
	    Selector.prototype.renderDefault = function renderDefault() {
	        this.wrapper.innerHTML = render.render(this.menuTmpl, this);
	        this.container.innerHTML = render.render(this.loadingTmpl, this);
	        return this;
	    };

	    Selector.prototype.renderMenu = function renderMenu() {
	        this.wrapper.innerHTML = render.render(this.menuTmpl, this);
	        return this;
	    };

	    Selector.prototype.renderList = function renderList() {
	        this.container.innerHTML = render.render(this.listerTmpl, this);
	        return this;
	    };

	    Selector.prototype.autoHide = function autoHide() {
	        if (this.autoClose) {
	            return this.hide();
	        }
	        return this;
	    ...
	    Selector.prototype.hide = function hide() {
	        if (!this.isShow) {
	            return this;
	        }
	        this.isShow = false;
	    ...
	    Selector.prototype.show = function show() {
	        if (this.isShow) {
	            return this;
	        }
	        this.isShow = true;
	    ...
	    Selector.prototype.hasClass = function hasClass(target, className) {
	    ...
	    Selector.prototype.addClass = function addClass(target, className) {
	    ...
	    Selector.prototype.removeClass = function removeClass(target, className) {
	        if (this.hasClass(target, className)) {
	    ...
	    Selector.prototype.toggle = function toggle() {
