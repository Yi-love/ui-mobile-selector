...
const cssTxt = '.ui-selector-menu-container,.ui-selector-menu-container *,.ui-selector-menu-container *:after,.ui-selector-menu-container *:before,'+
                ...
                '.ui-selector-menu-container .txt{padding-right:12px;font-size:14px;overflow:hidden;vertical-align:middle;height:20px;line-height:20px;display:inline-block;white-space:nowrap;max-width:100%;text-overflow:ellipsis;'+
                'position:relative;background-repeat:no-repeat;background-image:url(data:image/png;base64,);'+
